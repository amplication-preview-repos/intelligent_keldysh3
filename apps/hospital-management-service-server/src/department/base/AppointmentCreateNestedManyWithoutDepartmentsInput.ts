...
@InputType()
class AppointmentCreateNestedManyWithoutDepartmentsInput {
...
export { AppointmentCreateNestedManyWithoutDepartmentsInput as AppointmentCreateNestedManyWithoutDepartmentsInput };
